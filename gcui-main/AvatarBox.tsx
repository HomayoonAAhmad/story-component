...
export default function AvatarBox(props: AvatarBoxProps) {
  ...
  const [croppedImagePreview, setCroppedImagePreview] = React.useState(
    props.formAvatar ? props.formAvatar : "/assets/images/image-placeholder.svg"
  );
  let avatar = props.formAvatar
    ? props.formAvatar

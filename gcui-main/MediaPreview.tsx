                ...
                case "img":
                  return (
                    <div
                      key={index}
                      className={
                        "w-24 h-24 rounded-lg overflow-hidden cursor-pointer hover:scale-105 transition-all"
                      }
                ...
                case "video":
                  return (
                    <div
                      key={index}
                      className={
                        "w-24 h-24 rounded-lg overflow-hidden cursor-pointer  hover:scale-105 transition-all flex items-center justify-center bg-indigo-900"
                      }
                      onClick={() => setActiveItem(item)}
                    >
                ...
                case "pdf":
                  return (
                    <div
                      key={index}
                      className={
                        "flex items-center gap-2 cursor-pointer hover:scale-105 transition-all"
                      }
                      onClick={() => setActiveItem(item)}
                    >
                      <span className={"far fa-file-pdf text-red-400"} />

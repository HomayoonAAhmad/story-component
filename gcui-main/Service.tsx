...
export default function Service({ service }: { service: content }) {
  ...
  return (
    <Blocks.Gradient className={"relative"}>
      <div className={"relative z-10 -my-8 text-center pb-10  lg:px-4 px-2"}>
        ...
        <div className={"my-4 w-full"}>
          <Button
            ...
            icon={
              <span className={"fas fa-shopping-cart lg:flex hidden"}></span>
            }
      ...
      <div
        className={`absolute top-2 left-2 right-2 bottom-2 border border-orange-400 rounded-2xl ${
          service._featured ? "particular" : ""
        }`}
      >
        {service._featured == 1 && (
          <>
